            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                        <div class="product-image">
                            <div class="product-category">{{ $similar->category ?? 'Uncategorized' }}</div>
                            <a href="{{ route('each.product', $similar->id) }}">
                                <img src="{{ asset($similar->image) }}" alt="{{ $similar->image }}" class="imgs">
                                </a>
                        </div>
...
<div class="product-description">
    ...
    <button class="toggle-btn">Mostrar más</button>
                    ...
                    <div class="product-actions">
                           <form action="{{ route('cart.add', ['id' => $similar->id]) }}" method="POST">
                            @csrf
            ...
            <section class="recommendations">
                ...
                <div class="recommendations-grid">
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-price">${{ number_format($similar->price, 2) }}</div>
                        <p class="product-description">{{ $similar->description ?? 'No description available.' }}</p>
                        <div class="product-actions">
                            <button class="btn-secondary">Add to Chart</button>
